...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var esquioConnection, featureName, toggleType, productName, parameterName, parameterValue, deploymentName, esquioUrl, serverEndpointAuth, esquioApiKey, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, setToggleParameter(esquioUrl, esquioApiKey, productName, featureName, toggleType, parameterName, parameterValue, deploymentName)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
