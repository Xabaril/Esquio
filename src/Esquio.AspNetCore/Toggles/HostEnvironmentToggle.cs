...
namespace Esquio.AspNetCore.Toggles
{
    ...
    /// </summary>
    [DesignType(Description = "The host execution environment and its value is in the list.", FriendlyName = "Environment")]
    [DesignTypeParameter(ParameterName = Environments, ParameterType = EsquioConstants.SEMICOLON_LIST_PARAMETER_TYPE, ParameterDescription = "The ASP.NET Core host environments to activate this toggle separated by ';' character.")]
