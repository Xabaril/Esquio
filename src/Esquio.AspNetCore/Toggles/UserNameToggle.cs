...
namespace Esquio.AspNetCore.Toggles
{
    ...
    /// </summary>
    [DesignType(Description = "The identity name is in the list.", FriendlyName = "Identity name")]
    [DesignTypeParameter(ParameterName = Users, ParameterType = EsquioConstants.SEMICOLON_LIST_PARAMETER_TYPE, ParameterDescription = "The identity names to activate this toggle separated by ';' character.")]
