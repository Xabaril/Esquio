...
namespace Esquio.UI.Api.Features.Flags
{
    ...
    public class FeaturesController : ControllerBase
    {
        ...
        [Route("api/v1/products/{productName}/features")]
        ...
        [HttpPut]
        [Authorize(Policies.Write)]
        [Route("api/v1/products/{productName}/features/{featureName}")]
        ...
        [HttpPut]
        [Authorize(Policies.Write)]
        [Route("api/v1/products/{productName}/features/{featureName}/rollout")]
        ...
        [HttpPut]
        [Authorize(Policies.Write)]
        [Route("api/v1/products/{productName}/features/{featureName}/rollback")]
