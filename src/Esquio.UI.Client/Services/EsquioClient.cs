...
namespace Esquio.UI.Client.Services
{
    ...
    public partial interface IEsquioClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DetailsRingResponse> Products_GetProductRingsAsync(string productName);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DetailsRingResponse> Products_GetProductRingsAsync(string productName, System.Threading.CancellationToken cancellationToken);
