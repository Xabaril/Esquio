...
namespace Esquio.UI.Host.Infrastructure.Services
{
        ...
        : IDiscoverToggleTypesService
    {
        ...
        private static IEnumerable<Assembly> IntrospectionAssemblies = new Assembly[]
        {
            ...
            //esquip-contrib
            //typeof(Esquio.Toggles.Http.UserAgentBrowserToggle).Assembly,
            //typeof(Esquio.Toggles.GeoLocation.IpApiCountryNameToggle).Assembly
