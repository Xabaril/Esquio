...
namespace Esquio.Diagnostics
{
    internal static class EventIds
    {
        ...
        public static readonly EventId DefaultFeatureServiceEnd = new EventId(105, nameof(DefaultFeatureServiceEnd));
        public static readonly EventId DefaultFeatureServiceFromSession = new EventId(106, nameof(DefaultFeatureServiceFromSession));
