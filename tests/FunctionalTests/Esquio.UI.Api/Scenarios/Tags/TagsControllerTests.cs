    ...
    public class tags_controller_should
    {
        ...
        public async Task not_allow_to_untag_features_when_user_is_not_authenticated()
        {
            var response = await _fixture.TestServer
              .CreateRequest(ApiDefinitions.V5.Tags.Untag(productName: "fooproduct", featureName: "barfeature", tag: "peformance"))
              .DeleteAsync();
        ...
        public async Task not_allow_to_tag_features_when_feature_does_not_exists()
        {
            ...
            var response = await _fixture.TestServer
                .CreateRequest(ApiDefinitions.V5.Tags.Tag(productName: "fooproduct", featureName: "barfeature"))
                .WithIdentity(Builders.Identity().WithDefaultClaims().Build())
                .PostAsJsonAsync(request);
        ...
        {
            var response = await _fixture.TestServer
                .CreateRequest(ApiDefinitions.V5.Tags.List(productName: "fooproduct", featureName: "barfeature"))
                .WithIdentity(Builders.Identity().WithDefaultClaims().Build())
                .GetAsync();
